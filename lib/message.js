...
// 功能: 加群欢迎
//    加群 {
//     0|main  |   self_id: 1770874035,
//     0|main  |   time: 1658582424,
//     0|main  |   post_type: 'notice',
//     0|main  |   notice_type: 'group',
//     0|main  |   sub_type: 'increase',
//     0|main  |   group_id: 828192817,
//     0|main  |   user_id: 2083892646,
//     0|main  |   nickname: 'Gin.'
//     0|main  | }
    ...
    const reply = [
        {
            type: 'text',
            data: {
                text: `欢迎加入!${data.nickname}(${data.user_id})`
            }
        }
    ]
